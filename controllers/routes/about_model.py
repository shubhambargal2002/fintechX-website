...
class Page:
	def __init__(self, state: Union[Any, None]):
		...
		self.video2 = state["video2"] if "video2" in state else None
		...
		self.Div16 = state["Div16"] if "Div16" in state else None
	...
	@property
	def video2(self):
		self._getter_access_tracker["video2"] = {}
		return self._video2
	@video2.setter
	def video2(self, new_state):
		self._setter_access_tracker["video2"] = {}
		self._video2 = Flex(new_state)
