...
class Page:
	def __init__(self, state: Union[Any, None]):
		...
		self.signup_footer1 = state["signup_footer1"] if "signup_footer1" in state else None
		...
		self.undefined = state["undefined"] if "undefined" in state else None
		self._setter_access_tracker = {}
	...
	@property
	def signup_footer1(self):
		self._getter_access_tracker["signup_footer1"] = {}
		return self._signup_footer1
	@signup_footer1.setter
	def signup_footer1(self, new_state):
		self._setter_access_tracker["signup_footer1"] = {}
		self._signup_footer1 = Flex(new_state)
	...
	@property
	def undefined(self):
		self._getter_access_tracker["undefined"] = {}
		return self._undefined
	@undefined.setter
	def undefined(self, new_state):
		self._setter_access_tracker["undefined"] = {}
		self._undefined = Checkbox(new_state)
	...
	def _to_json_fields(self):
		return {
			...
			"Flex27": self._Flex27,
			"signup_footer1": self._signup_footer1,
			"Flex29": self._Flex29,
			"Flex30": self._Flex30,
